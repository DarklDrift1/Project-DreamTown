...
class World:
    ...
    def load_images(self):
        ...
        block = pg.image.load("assets/blockbordered.png").convert_alpha()
        tree = pg.image.load("assets/tree.png").convert_alpha()
        rock = pg.image.load("assets/rock.png").convert_alpha()
